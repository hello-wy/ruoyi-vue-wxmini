...
-- speaker 字段存储 lecturer_profile.id（多个用逗号分隔），供 FIND_IN_SET JOIN 使用
INSERT INTO `lectures` (`time`, `name`, `speaker`, `location`, `geo`, `detail`) VALUES
-- 较早的历史活动
('2025-10-15 14:00:00', '中考数学压轴题专项拆解',    '1898700000000003',                    '南京市玄武区图书馆一楼报告厅',   '118.800,32.050', '针对历年中考数学最后两道大题的专项拆解与训练，适合初三学生。'),
('2025-12-20 09:30:00', '青少年心理健康与家庭教育',   '1898700000000001',                    '南京市鼓楼区文化活动中心',       '118.770,32.060', '探讨青春期孩子的心理变化、叛逆期表现及家长的科学应对策略。'),

-- 刚刚过去的近期活动
('2026-02-28 15:00:00', '高效记忆法与英语词汇突破',   '1898700000000002',                    '南京市建邺区青年创客空间',       '118.740,32.010', '分享实用的记忆宫殿法与词根词缀记忆法，帮助学生快速扩大英语词汇量。'),

-- 即将到来的近期活动（两位讲师联合主讲）
('2026-03-08 19:00:00', '新高考志愿填报权威指南',     '1898700000000004',                    '南京市秦淮区教育局大礼堂',       '118.790,32.025', '全面解读最新高考政策与选科要求，指导高三学生及家长科学填报志愿，规避滑档风险。'),

-- 未来的活动
('2026-04-10 10:00:00', '少儿编程启蒙与人工智能',     '1898700000000005',                    '南京市雨花台区软件谷科技展厅',   '118.760,31.980', '面向小学生的 Scratch 编程基础体验课，结合简单的 AI 互动，激发科技创新兴趣。');
...
INSERT INTO `lecturer_profile` (`id`, `name`, `intro`, `avatar_url`, `poster_url`) VALUES
    ...
    (1898700000000003, '张名师',  '资深数学教师，专攻中考压轴题拆解与训练。',             'https://cdn.example.com/avatar/zhang.png','https://cdn.example.com/poster/zhang_poster.jpg'),
    (1898700000000004, '赵专家',  '高考志愿填报权威专家，深耕新高考政策研究。',           'https://cdn.example.com/avatar/zhao.png', 'https://cdn.example.com/poster/zhao_poster.jpg'),
    (1898700000000005, '孙工程师','人工智能与少儿编程教育推广者，擅长 Scratch 启蒙教学。','https://cdn.example.com/avatar/sun.png',  'https://cdn.example.com/poster/sun_poster.jpg');
