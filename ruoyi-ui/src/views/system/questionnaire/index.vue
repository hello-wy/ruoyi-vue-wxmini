<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="逻辑删除标识: 0-未删除, 1-已删除" prop="isDeleted">
        <el-input
          ...
          placeholder="请输入逻辑删除标识: 0-未删除, 1-已删除"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:questionnaire:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="questionnaireList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="问卷星链接URL" align="center" prop="url" />
      <el-table-column label="状态: 0-失效, 1-有效 (配合Java定时任务控制开课7天内有效)" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="问卷星链接URL" prop="url">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        url: [
          { required: true, message: "问卷星链接URL不能为空", trigger: "blur" }
        ],
        status: [
          { required: true, message: "状态: 0-失效, 1-有效 (配合Java定时任务控制开课7天内有效)不能为空", trigger: "change" }
        ],
      }
    }
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除问卷调查配置编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/questionnaire/export', {
        ...this.queryParams
