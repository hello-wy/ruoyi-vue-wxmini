<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="materialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="资料/PDF文件OSS链接" align="center" prop="url" />
      <el-table-column label="状态: 0-隐藏, 1-展示 (由后端接口业务调整)" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="资料/PDF文件OSS链接" prop="url">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        url: [
          { required: true, message: "资料/PDF文件OSS链接不能为空", trigger: "blur" }
        ],
        status: [
          { required: true, message: "状态: 0-隐藏, 1-展示 (由后端接口业务调整)不能为空", trigger: "change" }
        ],
      }
    }
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除资料中心数据编号为"' + ids + '"的数据项？').then(function() {
